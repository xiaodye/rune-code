# Deer Code Node 项目讲解文档

## 项目简介

Deer Code Node 是一个运行在终端（CLI）中的智能 AI 编程助手。它旨在通过自然语言对话，辅助开发者完成代码编写、文件操作、任务管理等工作。项目深度集成了 LLM（大语言模型）能力，通过 Agent 架构实现自主规划和执行。麻雀虽小，五脏俱全。
